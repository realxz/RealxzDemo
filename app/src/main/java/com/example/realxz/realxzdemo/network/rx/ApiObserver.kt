 ...
 * @date 2019/5/20
 */
abstract class ApiObserver<T> : DisposableSubscriber<T>() {

    override fun onNext(t: T) {
        onRealXzSuccess(t)
    }

    abstract fun onRealXzSuccess(response: T)
    ...
    open fun onRealXzFail(errorResponse: ApiResponse<*>) {
    ...
    open fun onRealXzError(errorMsg: String, exception: String = "") {
        toastErrorMsg(errorMsg)
    }
